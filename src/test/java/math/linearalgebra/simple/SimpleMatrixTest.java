...
public class SimpleMatrixTest {
    ...
    public void testMultiply() {
        ...
        assertEquals(new SimpleMatrix(new double[] { 0.01 * 1, 0.01 * 5, 0.01 * -3, 0.01 * 5 }), out2Matrix);
    }
    ...
    public void mapElements() {
        SimpleMatrix m = new SimpleMatrix(new double[][] { { 9, 1_000_000, 4 }, { 1, 16, 49 }, { 25, 81, 100 } });
