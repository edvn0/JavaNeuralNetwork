...
public final class ConverterUtil {
	...
	public static final Map<String, CostFunction<Primitive64Matrix>> ojCostFunctions = Map.of("Binary Cross Entropy",
			new BinaryCrossEntropyCostFunction<Primitive64Matrix>(), "Cross Entropy",
	...
	public static final Map<String, CostFunction<org.ujmp.core.Matrix>> ujmpCostFunctions = Map.of(
			"Binary Cross Entropy", new BinaryCrossEntropyCostFunction<org.ujmp.core.Matrix>(), "Cross Entropy",
