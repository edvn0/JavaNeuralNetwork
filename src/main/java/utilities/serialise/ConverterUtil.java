...
public final class ConverterUtil {
	...
	public static final Map<String, ActivationFunction<Primitive64Matrix>> ojFunctions = Map
		.of("DoNothing",
			...
			new LeakyReluFunction<Primitive64Matrix>(), "Linear",
			new LinearFunction<Primitive64Matrix>(),
			"ReLU", new ReluFunction<Primitive64Matrix>(), "Sigmoid",
			new SigmoidFunction<Primitive64Matrix>(), "Softmax",
			new SoftmaxFunction<Primitive64Matrix>(),
	...
	public static final Map<String, ActivationFunction<org.ujmp.core.Matrix>> ujmpFunctions = Map
		.of("DoNothing",
			...
			new LinearFunction<org.ujmp.core.Matrix>(), "ReLU",
			new ReluFunction<org.ujmp.core.Matrix>(),
			"Sigmoid", new SigmoidFunction<org.ujmp.core.Matrix>(), "Softmax",
			new SoftmaxFunction<org.ujmp.core.Matrix>(), "Tanh",
			new TanhFunction<org.ujmp.core.Matrix>());
	...
	public static final Map<String, Optimizer<org.ujmp.core.Matrix>> ujmpOptimisers = Map.of(
		"Adaptive Moment Estimation", new ADAM<org.ujmp.core.Matrix>(),
	...
	public static final Map<String, EvaluationFunction<Primitive64Matrix>> ojEvaluators = Map.of(
		"Argmax Evaluation", new ArgMaxEvaluationFunction<Primitive64Matrix>(),
