...
public class MNISTTester {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        List<NetworkInput> imagesTrain = generateDataFromCSV("C:\\Users\\edvin\\Downloads\\mnist_train.csv");
        List<NetworkInput> imagesValidate = generateDataFromCSV("C:\\Users\\edvin\\Downloads\\mnist_test.csv");
